...
namespace MargunStore.Infrastructure.Data.Settings
{
    public class AddressMap : IEntityTypeConfiguration<Address>
    {
        ...
        {
            builder.Property(value => value.Street).HasColumnType("VARCHAR(50)").IsRequired().HasMaxLength(50);
            ...
            builder.Property(value => value.Cep).HasColumnType("VARCHAR(20)").IsRequired();
